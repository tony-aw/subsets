...
#'
#' @description
#' This is an S3 Method to to modify (recursive subsets of) an object with explicit coercion. \cr
#' 
...
#' ```
#' 
#' (4) And for data.frame-like objects, with columns specified by `col`,
#' this method is equivalent to:
#' 
#' ```{r eval = FALSE}
