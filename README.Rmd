...
'subsets' uses a modified version of the `abind::abind()` function from the 'abind' R-package. This R-package is recommended for binding and sub-filling arrays of arbitrary dimensions. 
